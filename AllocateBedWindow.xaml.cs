    ...
    public partial class AllocateBedWindow : Window
    {
        ...
        private void radiobtnNormal_Checked(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                string Query = "select distinct ward_name from hope.ward_bed where bed_type='" + "Normal" + "';";
        ...
        private void radiobtnVIP_Checked(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                string Query = "select distinct ward_name from hope.ward_bed where bed_type='" + "VIP" + "';";
        ...
        private void comboboxChooseWard_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            try
            {
                ...
                string Query = "select bed_no from hope.ward_bed where ward_name='" + text + "' and bed_status='" + "Free" + "' and bed_type='" + check().ToString() + "';";
        ...
        private void submitBed_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                string Query = "update hope.bed set pat_contact_no='" + contact + "',bed_status='" + "Occupied" + "' where bed_no='" + comboboxChooseBed.SelectedItem.ToString() + "';";
                MySqlCommand MyCommand4 = new MySqlCommand(Query, conn);
                MySqlDataReader MyReader4;
                MyReader4 = MyCommand4.ExecuteReader();
                while (MyReader4.Read())
