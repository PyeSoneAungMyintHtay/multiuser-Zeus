...
namespace Project_Zeus
{
    ...
    public partial class DoctorWindow : Window
    {
        ...
        private void btnViewRequests_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                string sql1 = "select pat_name,pat_age,pat_address,pat_contact_no,appointment_date,appointment_status from hope.appointment where doc_id='" + loginAsDoctor.Text + "' and appointment_status='" + "pending" + "';";
                ...
                ///For Accepted Table
                string sql2 = "select pat_name,pat_age,pat_address,pat_contact_no,appointment_date,appointment_status from hope.appointment where doc_id='" + loginAsDoctor.Text + "' and appointment_status='" + "Accepted" + "';";
        ...
        private void btnPatientRecord_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                string sql1 = "select distinct pat_name,pat_contact_no,pat_age from hope.appointment where doc_id='" + loginAsDoctor.Text.ToString() + "' and appointment_status='" + "Checked" + "';";//
