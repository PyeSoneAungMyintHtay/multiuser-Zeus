...
namespace Project_Zeus
{
    ...
    public partial class AddMedicinePage : Page
    {
        ...
        private void txtMedicineName_TextChanged(object sender, TextChangedEventArgs e)
        {
            try
            {
                string Query6 = "SELECT COUNT(*) from hope.medicine_name where medicine_name='" + txtMedicineName.Text + "';";
        ...
        private void btnAddMedicine_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                try
                {
                    string Query = "insert into hope.supplier values('" + txtCompanyName.Text + "','" + txtContactNo.Text + "','" + txtMedicineName.Text + "','" + "Medicine" + "','" + txtDate.Text + "','" + txtQuantity.Text + "','" + txtBuyingPrice.Text + "','" + txtSellingPrice.Text + "');";
                    MySqlCommand MyCommand = new MySqlCommand(Query, conn);
                    MySqlDataReader MyReader;
                    MyReader = MyCommand.ExecuteReader();
                    MyReader.Close();

                    string Query1 = "insert into hope.medicine_name values('" + txtMedicineName.Text + "','" + comboDiseaseType.SelectedItem + "','" + comboDiseaseName.SelectedItem + "');";
