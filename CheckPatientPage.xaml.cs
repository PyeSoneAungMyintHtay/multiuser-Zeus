...
namespace Project_Zeus
{
    ...
    public partial class CheckPatientPage : Page
    {
        ...
        public void check_doctor_dept()
        {
            try
            {
                Query78 = "select department from hope.doctor where id='" + hmmtext.Text + "';";
                ...
                {
                    string Query100 = "select distinct disease_type from hope.medicine_name where disease_type='" + "Cardiac" + "';";
                ...
                else if (doc_dept.Equals("Nurology"))
                {
                    ...
                    string Query101 = "select distinct disease_type from hope.medicine_name where disease_type='" + "Neurological" + "';";
                ...
                {
                    string Query102 = "select distinct disease_type from hope.medicine_name where disease_type='" + "Orthopedic" + "';";
        ...
        public void load_check_list()
        {
            try
            {
                string sql = "select pat_name,pat_age,pat_address,pat_contact_no,appointment_date from hope.appointment where doc_id='" + hmmtext.Text.ToString() + "' and appointment_status='" + "Accepted" + "';";
        ...
        public void load_check_list_admitted()
        {
            try
            {
                string sql = "select patient_name,patient_age,patient_disease,patient_address,patient_contact_no,time_of_admission from hope.admitted_patient where doc_id='" + hmmtext.Text.ToString() + "' and checked_status='" + "Admitted" + "';";
                DataSet ds = new DataSet();
                MySqlDataAdapter da = new MySqlDataAdapter(sql, conn);
                da.Fill(ds);
                datagrid.ItemsSource = ds.Tables[0].DefaultView;
        ...
        public void see_medicine_list()
        {
            try
            {
                string sql = "SELECT product_name,quantity,days,time_of_day from hope.medicine where pat_contact_no='" + checkpatientContactNo.Text.ToString() + "'and appointment_date='" + checkpatientDate.Text.ToString() + "' and doc_id='" + hmmtext.Text + "';";
                DataSet ds = new DataSet();
                MySqlDataAdapter da = new MySqlDataAdapter(sql, conn);
                da.Fill(ds);
        ...
        public void see_test()
        {
            try
            {
                string sql = "SELECT test_name from hope.test where pat_contact_no='" + checkpatientContactNo.Text.ToString() + "' and appointment_date='" + checkpatientDate.Text.ToString() + "' and doc_id='" + hmmtext.Text + "';";
                DataSet ds = new DataSet();
                MySqlDataAdapter da = new MySqlDataAdapter(sql, conn);
                da.Fill(ds);
        ...
        private void btnRefreshMedList_Click(object sender, RoutedEventArgs e)
        {
            conn.Open();
            string sql = "SELECT product_name,quantity,days,time_of_day from hope.medicine where pat_contact_no='" + checkpatientContactNo.Text.ToString() + "'and appointment_date='" + checkpatientDate.Text.ToString() + "' and doc_id='" + hmmtext.Text + "';";
            DataSet ds = new DataSet();
        ...
        private void Remove_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                string sql = "DELETE FROM hope.medicine WHERE pat_contact_no='" + checkpatientContactNo.Text + "' AND appointment_date='" + checkpatientDate.Text + "' AND product_name='" + med_name + "' AND quantity='" + quantity + "' AND days='" + days + "' AND time_of_day='" + timeOfDay + "';";
        ...
        private void Submit_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                if (check().Equals("Accepted"))
                {
                    Query1 = "DROP TABLE hope.appointment_medicine;";
                    Query2 = "CREATE TABLE hope.appointment_medicine AS SELECT appointment.pat_name,appointment.pat_contact_no,appointment.appointment_date,appointment.pat_age,medicine.disease,medicine.product_name,medicine.quantity,medicine.days,medicine.time_of_day FROM appointment,medicine WHERE hope.appointment.pat_contact_no=hope.medicine.pat_contact_no AND hope.appointment.appointment_date=hope.medicine.appointment_date;";
                    Query9 = "DROP TABLE hope.appointment_test;";
                    Query8 = "CREATE TABLE hope.appointment_test AS SELECT appointment.pat_name,appointment.pat_contact_no,appointment.appointment_date,appointment.pat_age,test.test_name FROM appointment,test WHERE hope.appointment.pat_contact_no=hope.test.pat_contact_no AND hope.appointment.appointment_date=hope.test.appointment_date;";
                    Query3 = "update hope.appointment set appointment_status='" + "Checked" + "' where pat_contact_no='" + checkpatientContactNo.Text.ToString() + "' and appointment_date='" + checkpatientDate.Text.ToString() + "';";
                    i = 1;
                }

                if (check().Equals("Admitted"))
                {
                    Query1 = "DROP TABLE hope.admitted_medicine;";
                    Query2 = "CREATE TABLE hope.admitted_medicine AS SELECT admitted_patient.patient_name,admitted_patient.patient_contact_no,admitted_patient.time_of_admission,admitted_patient.patient_age,medicine.disease,medicine.product_name,medicine.quantity,medicine.days,medicine.time_of_day FROM admitted_patient,medicine WHERE hope.admitted_patient.patient_contact_no=hope.medicine.pat_contact_no AND hope.admitted_patient.time_of_admission=hope.medicine.appointment_date;";
                    Query9 = "DROP TABLE hope.admitted_test;";
                    Query8 = "CREATE TABLE hope.admitted_test AS SELECT admitted_patient.patient_name,admitted_patient.patient_contact_no,admitted_patient.time_of_admission,admitted_patient.patient_age,test.test_name FROM admitted_patient,test WHERE hope.admitted_patient.patient_contact_no=hope.test.pat_contact_no AND hope.admitted_patient.time_of_admission=hope.test.appointment_date;";
                    Query3 = "update hope.admitted_patient set checked_status='" + "Checked" + "' where patient_contact_no='" + checkpatientContactNo.Text + "' and time_of_admission='" + checkpatientDate.Text + "';";
                    i = 0;
                }
                ...
                if (i == 0)
                {
                    string Query67 = "DROP TABLE hope.admitted_medicine_cost;";
        ...
        private void radAcPat_Checked(object sender, RoutedEventArgs e)
        {
            ...
            load_check_list();
            Query = "select distinct disease_type from hope.medicine_name;";
        }
        ...
        private void PrescribeTest_Click(object sender, RoutedEventArgs e)
        {
            add_more_test();
        }
        ...
        private void radAdPat_Checked(object sender, RoutedEventArgs e)
        {
            ...
            Query = "select distinct disease_name from hope.medicine_name;";
        }
