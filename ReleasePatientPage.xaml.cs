    ...
    public partial class ReleasePatientPage : Page
    {
        ...
        private void btnReleasePatient_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                string Query = "insert into hope.release_patient values('" + txtPatientName.Text + "','" + txtPatientAge.Text + "','" + txtContactNo.Text + "','" + txtPatientAddress.Text + "','" + txtDisease.Text + "','" + txtDocName.Text + "','" + txtDateOfAdmit.Text + "','" + txtDateOfRelease.Text + "','" + txtDays.Text + "','" + txtMedicineCost.Text + "','" + txtTestCost.Text + "', '" + txtBedCost.Text + "', '" + txtTotalCost.Text + "');";
                ...
                string Query1 = "update hope.admitted_patient set checked_status='" + "Released" + "' where patient_contact_no='" + txtContactNo.Text + "';";
                ...
                string Query2 = "update hope.bed set pat_contact_no='" + "" + "', bed_status='" + "Free" + "' where pat_contact_no='" + txtContactNo.Text + "';";
                ...
                string Query3 = "DROP TABLE hope.ward_bed;";
                ...
                string Query5 = "DROP TABLE hope.allocate_patient_bed;";
                ...
                /*string Query5 = "select quantity,days from hope.admitted_medicine where product_name='" + comboboxMedicineName.SelectedItem + "';";
                MySqlCommand MyCommand5 = new MySqlCommand(Query5, conn);
                MySqlDataReader MyReader5;
                MyReader5 = MyCommand5.ExecuteReader();
                ...
                string Query6 = "update hope.supplier set quantity='" + x.ToString() + "' where product_name='" + comboboxMedicineName.SelectedItem + "' ;";
                MySqlCommand MyCommand6 = new MySqlCommand(Query6, conn);
                MySqlDataReader MyReader6;
                MyReader6 = MyCommand6.ExecuteReader();
                MyReader6.Close();*/
        ...
        private void txtContactNo_TextChanged(object sender, TextChangedEventArgs e)
        {
            try
            {
                string QueryLoadDetails = "select patient_name,patient_age,patient_address,doc_name,patient_disease from hope.admitted_patient where patient_contact_no='" + txtContactNo.Text + "' and checked_status='" + "Checked" + "' ";
                ...
                string Query = "select quantity,days,selling_price,time_of_admission from hope.admitted_medicine_cost where patient_contact_no='" + txtContactNo.Text + "' ";
                MySqlCommand MyCommand = new MySqlCommand(Query, conn);
                MySqlDataReader MyReader;
                MyReader = MyCommand.ExecuteReader();
                while (MyReader.Read())
                ...
                string QueryTest = "select test_cost from hope.admitted_test_cost where patient_contact_no='" + txtContactNo.Text + "' ";
        ...
        private void txtDays_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            string QueryBed = "select bed_cost from hope.allocate_patient_bed where patient_contact_no='" + txtContactNo.Text + "' ";
